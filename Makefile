...
SUBDIR+=	cross-pio-gccarmnoneeabi-1.70201.0
SUBDIR+=	crossguid
...
SUBDIR+=	py-cartopy
SUBDIR+=	py-caspy3
SUBDIR+=	py-castlevania
SUBDIR+=	py-castlevania-widgets
SUBDIR+=	py-catalogue
...
SUBDIR+=	terraform-provider-gandi
SUBDIR+=	terraform-provider-github
SUBDIR+=	terraform-provider-google
